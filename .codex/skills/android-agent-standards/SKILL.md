...
description: Global Android engineering standards for Codex. Use for Android, Kotlin, Jetpack Compose, Gradle, PR review, testing, accessibility, and security tasks.
---
